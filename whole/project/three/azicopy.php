...
<body>
    ...
    <div class="popular-event">
      <h4 class="popular-event">Sport</h4>
    </div>
    <div class="popular-event-image">
      ...
      <div class="second stage">
        <img src="./image/Seifu.jpg" alt="" class="seifu parts">
        <div class="row-star">
          <div class="paragraph">
            <p>Seifu On EBS</p>
      ...
      <div id="third stage">
        <img src="./image/Hachalu.jpg" alt="" class="stadium parts">
        <div class="row-star">
          <div class="paragraph">
    ...
    <!-- popular event -->
    <div class="popular-event">
      <h4 class="popular-event">Music</h4>
    </div>
    <div class="popular-event-image">
      <div class="first stage">
        <div>
    ...
    <!-- popular event -->
    <div class="popular-event">
      <h4 class="popular-event">Show</h4>
    </div>
    <div class="popular-event-image">
      <div class="first stage">
        <div>
